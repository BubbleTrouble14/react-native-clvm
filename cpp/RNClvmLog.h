...
namespace RNClvm
{
  ...
  public:
    ...
    {
#if defined(ANDROID) || defined(__ANDROID__)
      __android_log_write(ANDROID_LOG_INFO, "RNClvm", message.c_str());
#endif
...
#if defined(ANDROID) || defined(__ANDROID__)
      __android_log_write(ANDROID_LOG_INFO, "RNClvm", buffer);
#endif
#ifdef TARGET_OS_IPHONE
    ...
    {
      auto console = RNClvmLogger::getJavascriptConsole(runtime).asObject(runtime);
